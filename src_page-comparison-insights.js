...
(function(){
  ...
  function render(){
    ...
    return pageHeader('Comparison insights','Translate creative differences into an evidence-aware comparison.')+'<div class="compare-kicker"><span>CREATIVE DIFFERENTIAL</span><span>Observed differences · evidence-aware interpretation</span></div>'+
      '<section class="comparison-command"><div><span class="ops-eyebrow">COMPARISON ENGINE</span><h2>What actually changed between A and B?</h2><p>Separate attribute differences from measurable performance differences, then inspect the evidence without assuming causality.</p><div class="comparison-flow"><span>ATTRIBUTE</span><i>→</i><strong>DIFFERENCE</strong><i>→</i><span>PERFORMANCE</span></div></div><div class="comparison-core"><span>PAIR</span><strong>A / B</strong><small>under lens</small></div></section>'+renderGlobalDateRange()+selector+
      ...
      '<section class="score-compare compare-panel"><div class="compare-panel-head"><div><span class="compare-eyebrow">ATTRIBUTE LAYER</span><h2>Creative attribute differences</h2></div><span class="compare-count">'+i.diffs.length+' differences</span></div>'+attrHtml+'</section>'+
      '<section class="score-compare compare-panel"><div class="compare-panel-head"><div><span class="compare-eyebrow">PERFORMANCE LAYER</span><h2>Performance signals</h2></div><span class="compare-count">'+i.perf.length+' signals</span></div>'+perfHtml+'</section>'+
