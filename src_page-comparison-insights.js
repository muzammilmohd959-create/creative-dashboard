...
(function(){
  ...
  function render(){
    ...
    return pageHeader('Comparison insights','Translate creative differences into an evidence-aware comparison.')+'<div class="compare-kicker"><span>CREATIVE DIFFERENTIAL</span><span>Observed differences · evidence-aware interpretation</span></div>'+renderGlobalDateRange()+selector+
