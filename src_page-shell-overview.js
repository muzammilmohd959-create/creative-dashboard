    ...
    if (App.mode === 'empty') {
      return pageHeader('Overview', 'The command center for creator content, creative testing and measurable growth.') +
        ...
        '<section class="overview-feature-grid">' +
          '<button class="overview-feature" onclick="setPage(\'intelligence\',{})"><span class="feature-num">01</span><span class="feature-type">SIGNALS</span><span class="feature-glyph">✦</span><div class="feature-body"><strong>Creative Intelligence</strong><p>Trace the signals behind performance and move from raw metrics to evidence.</p><div class="feature-meter"><i style="width:86%"></i></div><small>Signal coverage <b>86%</b></small></div><span class="feature-arrow">↗</span></button>' +
          '<button class="overview-feature" onclick="setPage(\'patternExplorer\',{})"><span class="feature-num">02</span><span class="feature-type">COMPARE</span><span class="feature-glyph">⌁</span><div class="feature-body"><strong>Pattern Explorer</strong><p>Compare hooks, angles, formats, creators and campaigns across a selected range.</p><div class="feature-meter"><i style="width:72%"></i></div><small>Patterns mapped <b>72%</b></small></div><span class="feature-arrow">↗</span></button>' +
          '<button class="overview-feature" onclick="setPage(\'creativeOps\',{})"><span class="feature-num">03</span><span class="feature-type">EXECUTE</span><span class="feature-glyph">◈</span><div class="feature-body"><strong>Creative Operations</strong><p>Turn evidence into briefs, creator assignments, testing and production decisions.</p><div class="feature-meter"><i style="width:64%"></i></div><small>Workflow ready <b>64%</b></small></div><span class="feature-arrow">↗</span></button>' +
