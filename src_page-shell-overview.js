    ...
    if (App.mode === 'empty') {
      return pageHeader('Overview', 'The command center for creator content, creative testing and measurable growth.') +
        ...
        '<section class="overview-feature-grid">' +
          '<button class="overview-feature" onclick="setPage(\'intelligence\',{})"><span class="feature-num">01</span><span class="feature-type">SIGNALS</span><span class="feature-glyph">✦</span><div><strong>Creative Intelligence</strong><p>Trace the signals behind performance and move from raw metrics to evidence.</p></div><span class="feature-arrow">↗</span></button>' +
          '<button class="overview-feature" onclick="setPage(\'patternExplorer\',{})"><span class="feature-num">02</span><span class="feature-type">COMPARE</span><span class="feature-glyph">⌁</span><div><strong>Pattern Explorer</strong><p>Compare hooks, angles, formats, creators and campaigns across a selected range.</p></div><span class="feature-arrow">↗</span></button>' +
          '<button class="overview-feature" onclick="setPage(\'creativeOps\',{})"><span class="feature-num">03</span><span class="feature-type">EXECUTE</span><span class="feature-glyph">◈</span><div><strong>Creative Operations</strong><p>Turn evidence into briefs, creator assignments, testing and production decisions.</p></div><span class="feature-arrow">↗</span></button>' +
          '<button class="overview-feature" onclick="setPage(\'recommendations\',{})"><span class="feature-num">04</span><span class="feature-type">ACTION</span><span class="feature-glyph">↗</span><div><strong>Recommendations</strong><p>Translate observed performance signals into the next creative action.</p></div><span class="feature-arrow">↗</span></button>' +
        '</section>' +
